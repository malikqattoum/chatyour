...
if(role(['permissions' => ['coins' => 'allow_conversion']])) {
    ...
    $form['loaded']->title = Registry::load('strings')->grant_coins;
    $form['loaded']->button = Registry::load('strings')->grant_coins_button;

    $form['fields'] = new stdClass();

    $form['fields']->$todo = [
        "tag" => 'input', "type" => 'hidden', "class" => 'd-none', "value" => "coin_grant"
    ];
